...
VALUES('Z5CBgnCHiFsYXMmNdBYmKA','123456','test.tester', 'Privat', '1','kommentar' ,'Tilfeldig', '1', TRUE, FALSE), /*Won in the past*/
('Z5CBgnCHiFsYXMmNdBYmKA','123456','test.tester', 'Privat', '1', '','Tilfeldig', '2', TRUE, FALSE),
('Z5CBgnCHiFsYXMmNdBYmKA','123456','test.tester', 'Privat', '1', '','Tilfeldig', '4', TRUE, FALSE),
('Z5CBgnCHiFsYXMmNdBYmKA','123456','test.tester', 'Privat', '1', '','Tilfeldig', '5', FALSE, FALSE),
...
VALUES ('Hvordan avbestiller jeg en tur?', 'En tur kan avbestilles under mine turer eller ved å ta kontakt med example@company.com. Dersom man avbestiller senere enn to uker før avreise blir det en ekstra kostnad på 500 NOK.'),
...
('Hvem kontakter jeg dersom jeg har et spørsmål?', 'Dersom du har et spørsmål kan du ta kontakt med example@company.com');
