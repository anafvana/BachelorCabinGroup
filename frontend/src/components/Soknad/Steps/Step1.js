...
const Step1 = (props) => {
  ...
  const [enterpriseId, setEnterpriseId] = useState(props.formData.companyId);
  ...
  const submitStep1 = () => {
    ...
    if (enterpriseId === '') setShowCompanyFeedback(true);
    const step1Data = {
        ...
        {showExtraInfo && (
          <div className="step-extra-info-div">
            <p className="step-extra-info-p">
              EnterpriseID er din epost uten @company.com
            </p>
          </div>
        )}
