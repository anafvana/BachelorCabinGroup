...
func TestGetCreds(t *testing.T) {
	...
	if username != "example@email.com>" || passwd != "thisisanexamplepassword" {
...
func TestCabinValiditiy(t *testing.T) {
	valid := utils.CheckCabinValidation("Cabin1", "Tunvegen 11", 60.13, 10.23441, "Kjør hitover da", "Dette er en lang beskrivelse, tro det eller ei.", "Dette er en kort beskrivelse", 1200, 1200, 2, 5, 10)
	if !valid {
		t.Logf("Valid data is shown as not valid")
		t.Fail()
	}
